...
#' @param include_freq_zero If set "TRUE", the zero frequency is included for simulation in the spectral domain. Set "FALSE" for processes with singularity at frequency zero, such as the long-range dependent FARFIMA(p,d,q) process.
